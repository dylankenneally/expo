...
const EMPTY_REGISTRY: CompositionRegistry = new Map();
...
export function useCompositionRegistry() {
  const [registry, dispatch] = useReducer(registryReducer, EMPTY_REGISTRY);
 ...
 *
 * @param options - Navigation options to contribute
 */
